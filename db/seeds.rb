...
{
  name: "Ode mer",
  description: "The Lagoon 420 catamaran, with a length of 13 meters and a beam of almost 8 meters, offers more than 100m2 of surface area to the delight of our crew.This superb is characterized by its incredible interior layout which allows it to have 4 cabins with en-suite bathrooms, each equipped with a separate toilet and shower with hot water.et de douche avec eaux chaudes indépendants.",
...
{
  name: "Almaco IV",
  description: "This German-built boat is very little slack, all in wood, she has the look of an old rigging which makes all her charm. She has 3 cabins and a total of 6 berths, but is approved for 11 people for day trips.",
...
},
{
  ...
  category: "Fontaine Pajot Isla 40",
  capacity: 4,
  user: User.by_random.first
},
{
  name: "Vaimiti",
  description: "Sailboat Race/Cruise. 12 m sailboat equipped with 3 double cabins, saloon with dining table, kitchen (fridge, oven and double sink), chart table, shower room and WC. Hot water. On the technical side : genoa 53 m² on furler, mainsail 42 m² and 3 spinnakers of 110 m². Fishing rods and snorkelling equipment.",
